...
function soderg_razdela_3() {
    ...
    str += "<div id='ten2_gl_p'></div><div id='gl_p'class='c_gl_p_3'>Содержимое раздела:";
    ...
    str += "<div id='tp_" + i + "'class='c_ten_p_3'></div><div id='p_" + i + "'class='c_p_3' onmouseover='p_videlen_3(1, " + i + ")' onmouseout='p_videlen_3(2," + i + ")' onmousedown='p_videlen_3(4," + i + ")'></div>";
    //str_2+= "<div id='tp_" + i + "_2'class='c_ten_p_0'></div><div id='p_" + i + "_2'class='c_p_0'></div></div>";
    }
    str += "<div id='ten2'></div></div><div id='ten_vibronogo_p'class='c_ten_vibronogo_p_3'></div><div id='ogl_vibrono_copiy'class='c_ogl_vibrono_copiy_3'></div>";
    //---------------------------------------------------------------------------------------------
...
//=================================================================================================
//=================================================================================================
function p_videlen_3(deystvie, idnomer) {
    videl_chast = '#6080c0';
...
if(np_2==0){
    ...
    if(smena_rab)setTimeout('smena_stranic_3()',30);
}
...
//=================================================================================================
function on_kn_tp_na_str_3(deistvie_kn_tp,n_kn){
    color_kn_videl='#68a';
