        ...
        [//Главное
            [//От создателя сайта
                [//Приветствие
                    ...
                    '<div class="izobr"><table><tr><td><img class="foto_ymelca" src="IMG_20241119_042503.jpg"></td><td><div id="lud_1_name">Меня зовут <big><b>Ильина Людмила.</b></big></div><p> Я являюсь самостоятельно обученным <i>программистом, художником и рукодельницей.</i> </td></tr></table></div >' +
                    ...
                    '<p>В кратце расскажу, что обозначают разные цвета фона в тексте:<ul><li><span class="paragraf"><b>розовый</b></span> предназначен скрывать пункты списка или текст,<li><span class="metka"><b>салатовый</b></span> нужен для пояснения текста, расшифровки сокращений, шпоргалки, </li><li><span class="interes"><b>жёлтый</b></span> рассказывает об интересных людях и фактах,</li><li><span class="reshenie"><b>голубой</b></span> показывает ответы, пошаговое решение, перемещает пользователя в другие разделы.</li></ul>' +
                    '<p>Теперь окунемся в процесс ознакомления с проделанной мною работой.</p>'+
                    '<p>В меню <b>"Главное"</b> создала разделы <span id="tt_0"class="reshenie"><b>"Люди-умельцы"</b></span> и <span id="tt_0_"class="reshenie"><b>"Творческие работы"</b></span>. Уверена, что ознакомление с ними пробудит в Вас любовь к творчеству. Посещение страниц умельцев в этих разделах может привести к рождению орегинальных идей. По-крайней мере, со мной это точно срабатывает.</p>' +
                    ...
                    '<p>Вы не только будете созирцать на творения других людей, но и сами сможете опубликовывать свои работы. Для этого в разделе <span id="tt_0_2_0_"class="reshenie"><b>"Люди-умельцы"</b></span> имеется <span id="tt_0_2_2_"class="reshenie">запись в эту группу</span>. От Вас требуется сделать хотя бы одну вещь своими руками и можете вступать в наш дружный коллектив. Но не забывайте, что вся информация от мастеров проходит через меня, и <b>рекламы</b>, не связанной с Вашими работами, <b>я публиковать не буду!</b></p>' +
                    '<p>Проверьте свои знания или научитесь чему-то новому в меню <b>"Обучение"</b>. Здесь находятся: <p><ul><li><span id="tt_"class="reshenie"><b>уроки от умельцев,</b></span></li><li><b> материал, изученный мной в школе, по книгам и через интернет,</b></li><li><span id="tt_"class="reshenie"><b>литературные произведения</b></span></li><li><span id="tt_"class="reshenie"><b>энциклопедии</b></span></li><li><span id="tt_"class="reshenie"><b>созданные мной обучающие игры для самых маленьких.</b></span></li></ul></p>' +
                    ...
                    '<p>Но у меня не совсем обычная структура повествования. Как я писала выше, для удобства обучения, будет попадаться текст написанный на цветном фоне. При нажатии на него открывается дополнительная информация. </p>' +
                    ...
                    '<p>Я не метеор, а простая женщина, загруженная другими делами, поэтому всё успевать не смогу. Вы должны меня понять. Все изменения по сайту и его разделам будут отмечаться в меню <span id="tt_"class="reshenie"><b>"Главное / Чего новенького"</b></span>.</p>' +
                    '<p>Если появятся вопросы, предложения или критика, то милости прошу в меню <b>"Обсуждение"</b>. Здесь Вы сможете <span id="tt_0"class="reshenie">пообщаться</span> с другими пользователями или <span id="tt_"class="reshenie">написать письмо</span> лично мне. При наборе текста в разделе <span id="tt_"class="reshenie"><b>"Беседы"</b></span>, пожалуйста, фильтруйте свою лексику, так как Ваше высказывание автоматически записывается в файл и не контролируется мной. Зато шифрование здесь тоже не используется, и Ваша запись легко может быть проверена правохранительными органами, если поступит на Вас жалоба в соответствующие инстанции. <b>Поэтому не балуйтесь!!! /:(</b></p>' +
                    '<p>Были описаны не все разделы меню. Если хотите получить более подробную информацию, то перейдите в пункт <span id="tt_0"class="reshenie"><b>"Содержимое сайта"</b></span>. Если же Вас интересует как работает весь сайта, то Вы можете зайти в меню <span id="tt_0"class="reshenie"><b>"Справка / Инструкция по сайту"</b></span>.</p>' +
                ...
                [//Особенности сайта
                    //Начальная страница
                    '<h2><b><i>Для более полезного использования сайта, ознакомтесь с данным разделом!</i></b></h2>' +
                    '<p>Возможно Вы уже заметили, что текст напичкан надписями на разноцветном фоне. Это сделанно для удобного сокращения статей, пояснения надписей и быстрого перемещения пользователя по сайту. </p>' +
                    '<p>Объясню, что обозначают разные цвета заднего фона, а Вы можете лично проверить работу этих надписей: </p>' +
                    '<dl><dt><div id="paragraf_0_1_0" class="paragraf">Розовым цветом</div></dt> <dd>выделяются надписи, открывающие списки или сам текст, отделённые от остального материала отступом и чёрными линиями с начала и в конце. Обычно, я скрываю таким образом разделы содержания, тексты параграфов или ответы на вопросы. <dd>' +
                    '<p><dt><span id="reshenie_0_1_0" class="reshenie">Голубым цветом</span></dt><dd> выделена надпись, переносящая пользователя в упомянутый раздел сайта, или приглашающая Вас, открыть текст с ответами, подробным решением или поэтапным прохождением различных задач. Во втором случае открытая информация отделяется от другого текста синей рамкой. Это очень удобно, когда, после самостоятельного решения, хочется проверить свой ответ или ознакомиться с иными способами.</dd> </p>' +
                    '<p><dt><span id="metka_0_1_0" class="metka">Салатовый цвет</span></dt><dd> указывает на то, что есть пояснение, шпаргалка, коментарий для данной надписи или расшифровка сокращений. Очень удобно присутствие подобного рода "напоминалки" в тексте. Открывается поверх другой информации. </dd></p>' +
                    '<p><dt><span id="interes_0_1_0" class="interes">Жёлтым цветом</span></dt><dd>выделена надпись, содержащяя интересные факты, достижения или биографии связаные с данной темой. Это полезно знать тем, кто хочет расширить свой кругозор и увеличить уровень знаний. Так же открывается поверх другой информации.</dd></p>'+
                    '</dl>'+
                    '<p>Всплывающий текст исчезает после щелчка за его пределами. Правило распространяется для всех вышеперечисленых выделенных надписей.</p>' +
                    '<p>Есть и другие сокращения для текта:'+
            ...
            [//Чего новенького
                [//Все новости
                    ...
                    '<div id="tt_0" class="nowosti"><table width="90%"><tr width="80%"><td>Название новости</td><td>Дата и время</td></tr><tr><td colspan="2">Новость, которую хотят видеть пользователи.</td></tr></table></div>'
                ],
                [//Об умельцах
            ...
            [//Люди-умельцы
                [//Список с начала
                    '<p><div class="izobr"><table><tr><td><img class="foto_ymelca" src="IMG_20241119_042503.jpg"></td><td><div id="lud_1_name"><big><b>Ильина (Ковалёва) Людмила.</b></big></div><p> <i>Программист, художник и рукодельница.</i> </td></tr></table></div>' +
                    '<p><div class="izobr"><table><tr><td><img class="foto_ymelca" src="IMG_20241119_042503.jpg"></td><td><div id="lud_1_name"><big><b>Ильина (Ковалёва) Людмила.</b></big></div><p> <i>Программист, художник и рукодельница.</i> </td></tr></table></div>' +
                    '<p><div class="izobr"><table><tr><td><img class="foto_ymelca" src="IMG_20241119_042503.jpg"></td><td><div id="lud_1_name"><big><b>Ильина (Ковалёва) Людмила.</b></big></div><p> <i>Программист, художник и рукодельница.</i> </td></tr></table></div>'
                ],
                [//Список с конца
        ...
        [//Обучение
            [//Обучение от умельцев
                [//Обучающие уроки по мере поступления
                    ...
                    '<div class="izobr"><table><tr><td> <big><b>Заголовок занятия</b></big> <p>Краткое описание урока с указанием его направления в творчестве</td><td align="center"width="30%"><img class="foto_ymelca_min" src="IMG_20241119_042503.jpg"><div id="name_ymelca"><big><b>Ильина (Ковалёва) Людмила.</b></big></div></td></tr></table></div><p>' +
                    '<div class="izobr"><table><tr><td> <big><b>Заголовок занятия</b></big> <p>Краткое описание урока с указанием его направления в творчестве</td><td align="center"width="30%"><img class="foto_ymelca_min" src="IMG_20241119_042503.jpg"><div id="name_ymelca"><big><b>Ильина (Ковалёва) Людмила.</b></big></div></td></tr></table></div><p>' +
                    '<div class="izobr"><table><tr><td> <big><b>Заголовок занятия</b></big> <p>Краткое описание урока с указанием его направления в творчестве</td><td align="center"width="30%"><img class="foto_ymelca_min" src="IMG_20241119_042503.jpg"><div id="name_ymelca"><big><b>Ильина (Ковалёва) Людмила.</b></big></div></td></tr></table></div><p>' +
                    '<div class="izobr"><table><tr><td> <big><b>Заголовок занятия</b></big> <p>Краткое описание урока с указанием его направления в творчестве</td><td align="center"width="30%"><img class="foto_ymelca_min" src="IMG_20241119_042503.jpg"><div id="name_ymelca"><big><b>Ильина (Ковалёва) Людмила.</b></big></div></td></tr></table></div><p>' +
                    '<div class="izobr"><table><tr><td> <big><b>Заголовок занятия</b></big> <p>Краткое описание урока с указанием его направления в творчестве</td><td align="center"width="30%"><img class="foto_ymelca_min" src="IMG_20241119_042503.jpg"><div id="name_ymelca"><big><b>Ильина (Ковалёва) Людмила.</b></big></div></td></tr></table></div><p>' +
...
'<p>Выберите нужного Вам мастера:<p>'+
                    '<div class="izobr"><table><tr><td align="center"width="30%"><img class="foto_ymelca_min" src="IMG_20241119_042503.jpg"><div id="name_ymelca"><big><b>Ильина (Ковалёва) Людмила.</b></big></div></td><td> Перечисления направления занятий.</td></tr></table></div><p>' +
                    '<div class="izobr"><table><tr><td align="center"width="30%"><img class="foto_ymelca_min" src="IMG_20241119_042503.jpg"><div id="name_ymelca"><big><b>Ильина (Ковалёва) Людмила.</b></big></div></td><td> Перечисления направления занятий.</td></tr></table></div><p>' +
                    '<div class="izobr"><table><tr><td align="center"width="30%"><img class="foto_ymelca_min" src="IMG_20241119_042503.jpg"><div id="name_ymelca"><big><b>Ильина (Ковалёва) Людмила.</b></big></div></td><td> Перечисления направления занятий.</td></tr></table></div><p>' +
                    '<div class="izobr"><table><tr><td align="center"width="30%"><img class="foto_ymelca_min" src="IMG_20241119_042503.jpg"><div id="name_ymelca"><big><b>Ильина (Ковалёва) Людмила.</b></big></div></td><td> Перечисления направления занятий.</td></tr></table></div><p>' +
                    '<div class="izobr"><table><tr><td align="center"width="30%"><img class="foto_ymelca_min" src="IMG_20241119_042503.jpg"><div id="name_ymelca"><big><b>Ильина (Ковалёва) Людмила.</b></big></div></td><td> Перечисления направления занятий.</td></tr></table></div><p>' 
...
function Sait_load() {
    ...
    //---------------------------------------------------------------------------------------------
    if (localStorage.getItem('p_m')) { }//if (localStorage.getItem('p_m') >= array_menu[0].length) localStorage.setItem('p_m', 0) }   
