...
array_text =
    [
        [//Главное
            [//От создателя сайта
                ...
                [//Содержимое сайта
                    ...
                    '<ul><li><div id="tt_0_0_2_0" class="paragraf" onmousedown="on_tt_0_0_2(0)"onmouseover="on_paragraf(1,0,0,2,0)"onmouseout="on_paragraf(2,0,0,2,0)">"Главное" содержит разделы:</div>'+
                    '<div id = "tt_0_0_2_0_telo"></div></li></ul>'+
                    '<ul><li><div id="tt_0_0_2_1" class="paragraf" onmousedown="on_tt_0_0_2(1)" onmouseover="on_paragraf(1,0,0,2,1)" onmouseout="on_paragraf(2,0,0,2,1)">"Обучение" содержит разделы:</div>'+
                    '<div id="tt_0_0_2_1_telo"></div></li></ul>'+
                    '<ul><li><div id="tt_0_0_2_2" class="paragraf" onmousedown="on_tt_0_0_2(2)" onmouseover="on_paragraf(1,0,0,2,2)" onmouseout="on_paragraf(2,0,0,2,2)">"Обсуждение" содержит разделы:</div>'+
                    '<div id="tt_0_0_2_2_telo"></div></li></ul>'+
                    '<ul><li><div id="tt_0_0_2_3" class="paragraf" onmousedown="on_tt_0_0_2(3)" onmouseover="on_paragraf(1,0,0,2,3)" onmouseout="on_paragraf(2,0,0,2,3)">"Справка" содержит разделы:</div>'+
                ...
                [//Настройки сайта
                        'здесь предполагается изменение внешнего вида самого сайта или только лишь окраски'
                    
                ]
            ],
            [//Чего новенького
                [//Все новости
                    'здесь будут хрониться новости о произошедших изменениях на сайте'
                ],
                [//Об умельцах
                    'здесь представлены новости, касающиеся только умельцев, их новые работы и обучающие уроки'
                ],
                [//Об обучении
                    'новости касающиеся обучения, с возможностью посмотреть на эти разделы и параграфы'
                ],
                [//По выбранной категории
                    'предстаёт список категорий новостей на выбор'
                ]
            ],
            [//Люди-умельцы
                [//Список с начала 
        ...
        [//Обучение
            ...
            [//Творчество
                [//Все, освоенные мною, виды творчества
                ],
