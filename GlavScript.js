...
array_razd_p = [[
    ...
    ['Обучающий курс', 'Теоремы, определения, формулы', 'Графики, таблицы, рисунки', 'Вещества, их структура и особенности', 'Животные, птицы, пресноводные, насекомые', 'Растения', 'Интересные факты', 'Выдающиеся личности', 'Задачи для самооценки', 'Лабораторные работы', 'Вопросы для самопроверки', 'Используемая литература'], 
    ...
    ['Обучающий курс', 'Определения, понятия', 'Графики, таблицы, рисунки', 'Обитатели', 'Растения', 'Что добывают', 'Интересные факты', 'Выдающиеся личности', 'Вопросы для самопроверки', 'Используемая литература'],
    ['Обучающий курс', 'Определения, понятия', 'Графики, таблицы, рисунки', 'Обитатели', 'Растения', 'Что добывают', 'Интересные факты', 'Выдающиеся личности', 'Вопросы для самопроверки', 'Используемая литература'],
...
function prydki_() {
    switch (prydki_variant) {
        ...
        //    if (kn_prydki_start == false) {
            ...
            //        pomoshnik.style.width = pomoshnik.clientWidth+ 2 * glaz_l.clientWidth + glaz_l.clientWidth / 4 + 'px';
                //      pomoshnik.style.left = '0px'; 
                //pomoshnik.style.left = 2 * glaz_l.clientWidth + 25 + 'px';
    ...
    switch (deistvie) {
        ...
        case 4://down
            ...
            if (idnomer == 0 && nomer == 7) {
                ts_0_6_0.innerHTML = nachalo_istorii + ts_0_6_0.innerHTML;
