...
function Sait_load() {
    ...
    document.getElementById('razdel_teni').innerHTML = document.getElementById('razdel').innerHTML = array_menu[localStorage.getItem('punkt_menu')-0+1][localStorage.getItem('razdel_punkta') - 1];
    //---------------------------------------------------------------------------------------------
    //okno_top = 170;
    //---------------------------------------------------------------------------------------------
    ...
    switch (deystvie) {
        ...
        case 4://down
            ...
            if (ogl_vibrono != idnomer) {
                ...
                document.getElementById('ts_' + localStorage.getItem('punkt_menu') + '_' + localStorage.getItem('razdel_punkta') + '_' + localStorage.getItem('n_razdela')).style.display = 'none';
                ...
                document.getElementById(s_ekrana).style.display = 'block';
                ts_0_6_0.innerHTML = ts_0_6_0.innerHTML + "<p>" + localStorage.getItem('n_name') + "</p> <div id='pamyt_" + localStorage.getItem('n_name') + "' class='paragraf'onmousedown='on_pamyt(" + localStorage.getItem('punkt_menu') + "," + localStorage.getItem('razdel_punkta') + "," + idnomer + ")'> " + array_menu[0][localStorage.getItem('punkt_menu')] + ' / ' + array_menu[localStorage.getItem('punkt_menu') - 0 + 1][localStorage.getItem('razdel_punkta') - 1] + ' / ' + array_razd_p[localStorage.getItem('punkt_menu')][localStorage.getItem('razdel_punkta') - 1][idnomer] + '</div>';
                localStorage.setItem('n_name', localStorage.getItem('n_name') - 0 + 1);
...
function menu_(deistvie, nomer, idnomer) {
    ...
    switch (deistvie) {
        ...
        case 4://down
            ...
            document.getElementById(s_ekrana).style.display = 'block';
            ts_0_6_0.innerHTML = ts_0_6_0.innerHTML + "<p>" + localStorage.getItem('n_name') + "</p> <div id='pamyt_" + localStorage.getItem('n_name') + "' class='paragraf'onmousedown='on_pamyt(" + localStorage.getItem('punkt_menu') + "," + localStorage.getItem('razdel_punkta') + "," + localStorage.getItem('n_razdela') + ")'>" + array_menu[0][idnomer] + ' / ' + array_menu[idnomer + 1][nomer - 2] + ' / ' + array_razd_p[idnomer][nomer - 2][0] + '</div > ';
...
function on_pamyt(elm,elp,elr) {
    ...
    if (elm == 0 && elp == 6 && elr == 0) { } else {
        ts_0_6_0.innerHTML = ts_0_6_0.innerHTML + "<p>" + localStorage.getItem('n_name') + "</p> <div id='pamyt_" + localStorage.getItem('n_name') + "' class='paragraf'onmousedown='on_pamyt(" + elm + "," + elp + "," + elr + ")'>" + array_menu[0][elm] + ' / ' + array_menu[elm - 0 + 1][elp - 1] + ' / ' + array_razd_p[elm][elp - 1][elr] + '</div > ';

        localStorage.setItem('n_name', localStorage.getItem('n_name') - 0 + 1);
        localStorage.setItem('punkt_menu', elm);
        localStorage.setItem('razdel_punkta', elp);
        localStorage.setItem('n_razdela', elr);
